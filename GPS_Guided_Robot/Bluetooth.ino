...
void bluetooth()
{
   if (blueToothVal == 0)
    ...
    {  
      digitalWrite(ledPin1, HIGH); // เปิด LED ตัวที่ 1 เมื่อไม่ได้เชื่อมต่อ
      digitalWrite(ledPin2, LOW);  // ปิด LED ตัวที่ 2 เมื่อไม่ได้เชื่อมต่อ

    }
    else
    {    
      digitalWrite(ledPin1, LOW);  // ปิด LED ตัวที่ 1 เมื่อเชื่อมต่อ
      digitalWrite(ledPin2, HIGH); // เปิด LED ตัวที่ 2 เมื่อเชื่อมต่อ
